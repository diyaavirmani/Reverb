...
const requestSchema = z
  .object({
    provider: PromotionProviderSchema,
    package: PromotionPackageSchema,
    campaignContext: SensoCampaignContextSchema
  })
  .strict();
...
export async function POST(request: Request) {
  ...
  try {
    const result = await createSensoAdapter().verifyProvider(
